package main.scala.overlapping.timeSeriesOld.secondOrder.multivariate.bayesianEstimators.lossFunctions
 ...
 */
class DiagonalNoiseMALoss[IndexT](
  ...
  def apply(params: Array[DenseMatrix[Double]],
            data: Array[(TSInstant[IndexT], DenseVector[Double])],
