package main.scala.overlapping.timeSeriesOld.secondOrder.multivariate.bayesianEstimators.procedures

import breeze.linalg._
import breeze.numerics.sqrt
import main.scala.overlapping.timeSeriesOld.Stability
